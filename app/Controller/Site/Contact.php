...
class Contact extends Page {
	...
	public static function index($request){
		...
		return parent::getPanel('Contato', $content, 'contato',
			'Contato comercial — CTI Educacional',
			'Solicite uma demonstração da plataforma CTI para sua escola profissionalizante. Fale com nosso time comercial.'
		);
	...
	private static function sendAcknowledgment(Email $obEmail, string $nome, string $email, string $assunto): void {
		...
		$ackBody = '<p>Olá <b>'.htmlspecialchars($nome, ENT_QUOTES, 'UTF-8').'</b>,</p>'
			...
			.'<p>Nossa equipe comercial retornará em breve no e-mail ou telefone que você informou.</p>'
