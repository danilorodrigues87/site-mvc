...
$(document).on("submit", "#pega_lead", function(event) {
        event.preventDefault(); // Evita o envio do formulário de forma tradicional

        $.ajax({
            url: urlBase+'/home-pega-lead',
            type: "POST",
            ...
            success: function(response) {
             ...
             document.getElementById('ld_nome').value = '';
             document.getElementById('ld_email').value = '';
             document.getElementById('ld_whatsapp').value = '';
             document.getElementById('ld_curso').value = '';
             document.getElementById('ld_ex_aluno').value = '';
    ...
    // FUNÇÃO QUE EXECUTA UM CREATE OU UPDATE DE DADOS
$(document).on("submit", "#contato-home", function(event) {
        event.preventDefault(); // Evita o envio do formulário de forma tradicional
